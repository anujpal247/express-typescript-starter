...
/* Represents a Bad Request error (HTTP 400).
 This error is typically used to indicate that the server cannot  process   the request due to client-side issues such as invalid input or malformed request syntax.
*/
...
/*  
 ...
 This error is typically used to indicate that the server understands the request but refuses to authorize it.
*/
...
/*  Represents a Conflict error (HTTP 409).
  This error is typically used to indicate that the request could not be completed due to a conflict with the current state of the target resource.
*/
